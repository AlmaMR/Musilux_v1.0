...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tagAudio = Tag::create(['nombre' => 'Audio']);
        ...
        ProductSpec::create(['id_producto' => $nirvana->id, 'clave' => 'Dimensiones', 'valor' => '31x31 cm']);
        ProductSpec::create(['id_producto' => $nirvana->id, 'clave' => 'Discos', 'valor' => '1']);
        ProductImage::create(['id_producto' => $nirvana->id, 'tipo_multimedia' => 'imagen', 'url_archivo' => 'https://images.unsplash.com/photo-1526478806334-5fd488fcaabc?w=600', 'es_principal' => true]);
        ProductImage::create(['id_producto' => $nirvana->id, 'tipo_multimedia' => 'imagen', 'url_archivo' => 'https://images.unsplash.com/photo-1619983081563-430f63602796?w=100', 'es_principal' => false]);
        ...
        ProductSpec::create(['id_producto' => $fender->id, 'clave' => 'Cuerpo', 'valor' => 'Aliso']);
        ProductSpec::create(['id_producto' => $fender->id, 'clave' => 'Mástil', 'valor' => 'Arce']);
        ProductImage::create(['id_producto' => $fender->id, 'tipo_multimedia' => 'imagen', 'url_archivo' => 'https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?w=600', 'es_principal' => true]);
        ...
        ProductSpec::create(['id_producto' => $beam->id, 'clave' => 'Potencia', 'valor' => '230W']);
        ProductSpec::create(['id_producto' => $beam->id, 'clave' => 'DMX', 'valor' => 'Sí']);
        ProductImage::create(['id_producto' => $beam->id, 'tipo_multimedia' => 'imagen', 'url_archivo' => 'https://images.unsplash.com/photo-1533923156502-be31530547c4?w=600', 'es_principal' => true]);
        ...
        ProductImage::create(['id_producto' => $bateria->id, 'tipo_multimedia' => 'imagen', 'url_archivo' => 'https://m.media-amazon.com/images/S/aplus-media-library-service-media/e04da6f5-c8dd-43a8-b82a-ef27cb61cec2.__CR0,0,600,600_PT0_SX300_V1___.png', 'es_principal' => true]);
        ...
        ProductImage::create(['id_producto' => $djControl->id, 'tipo_multimedia' => 'imagen', 'url_archivo' => 'https://m.media-amazon.com/images/I/81O80Pn0ZsL._AC_UF1000,1000_QL80_.jpg', 'es_principal' => true]);
        ...
        ProductImage::create(['id_producto' => $taylor->id, 'tipo_multimedia' => 'imagen', 'url_archivo' => 'https://m.media-amazon.com/images/I/7115TB+TXeL.jpg', 'es_principal' => true]);
    }
}
