    ...
    public function run(): void
    {
        ...
        $productos = [
            ...
            [
                ...
                'tipo_producto'       => 'fisico',
                'esta_activo'         => true,
                'spotify_track_name'  => 'Smells Like Teen Spirit',
                'spotify_artist_name' => 'Nirvana',
                'bpm'                 => 117,
            ],
            [
                'id_categoria'        => 3,
                ...
                'tipo_producto'       => 'fisico',
                'esta_activo'         => true,
                'spotify_track_name'  => 'Thriller',
                'spotify_artist_name' => 'Michael Jackson',
                'bpm'                 => 118,
            ],
            [
                'id_categoria'        => 3,
                ...
                'tipo_producto'       => 'fisico',
                'esta_activo'         => true,
                'spotify_track_name'  => 'Money',
                'spotify_artist_name' => 'Pink Floyd',
                'bpm'                 => 122,
            ],
            [
                'id_categoria'        => 3,
            ...
            [
                ...
                'tipo_producto'       => 'fisico',
                'esta_activo'         => true,
                'spotify_track_name'  => 'Go Your Own Way',
                'spotify_artist_name' => 'Fleetwood Mac',
                'bpm'                 => 158,
            ],
        ];
